/**
 * created on 2017年9月5日 下午1:25:31
 */
...
/**
 * A sub-class of {@link MimeType} that adds support for quality parameters as
...
public class MediaType extends MimeType implements Serializable {
     ...
     * {@link #includes(MediaType)}, except that it <b>is</b> symmetric.
     * 
     * @param other
     *            the reference media type with which to compare
    ...
    public static MediaType parseMediaType(String mediaType) {
        ...
        try {
            ...
            throw new InvalidMimeTypeException(mediaType, ex.getMessage());
        }
    }
     ...
     * @see <a href="http://tools.ietf.org/html/rfc7231#section-5.3.2">HTTP 1.1:
